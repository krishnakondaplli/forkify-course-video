...
export const updateServings = function (newServings) {
  ...
  //Here we need to update state servings to otherwise it will again take old servings for calculation.
...
export const deleteBookmark = function (id) {
  ...
  //Mark current reicpe as NOT bookmarked
  if (id === state.recipe.id) state.recipe.bookmarks = false;
  persistBookmark();
};

// const init = function (storage) {
